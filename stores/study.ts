...
export const useStudyStore = defineStore('study', {
  ...
  getters: {
    ...
    // Sample count - use study's allSampleCount for consistency with home page
    sampleCount: (state): number => {
      // Primary: use allSampleCount from study (matches home page display)
      if (state.currentStudy?.allSampleCount) {
        return state.currentStudy.allSampleCount
      }
